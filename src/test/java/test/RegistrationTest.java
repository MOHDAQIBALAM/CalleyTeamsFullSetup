...
public class RegistrationTest extends Base_Class {
	Log log;
...
//	}
	...
	public void reference() {
		ExcelReader = new com.Utility.ExcelReader("Registration");
		log = new Log();
	...
	public void RUNALL(Map<Object, Object> testdata, ITestContext context) throws Throwable {
		try {
			...
			if (testdata.get("Run").toString().equalsIgnoreCase("Yes")) {
				...
				RegistrationPage.RegisterForm(Your_Name,Your_Email,Your_Password,WhatsappNo);
